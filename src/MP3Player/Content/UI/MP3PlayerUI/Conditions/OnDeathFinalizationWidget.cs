...
{
    public class OnDeathFinalizationWidget : MP3Widget
    {
        ...
        public OnDeathFinalizationWidget(MP3PlayerMainPanel panel, string uuid) : base(panel)
        {
            this.uuid = uuid;
        ...
        public override void AcceptInput(ButtonType type)
        {
            ...
            switch (type)
            {
                ...
                case ButtonType.Next:
                    store.AddCondition(MP3PlayerDataStore.OnDeathKey, uuid);

                    Main.NewText(LocalizationHelper.GetGUIText("MP3PlayerMenu.SetNewOnDeath"), MP3Player.Cyan);
        ...
        private void DrawWarning(SpriteBatch spriteBatch, Rectangle drawBox)
        {
            ...
            if (banner != null)
            {
                ...
                info = LocalizationHelper.GetGUIText("MP3PlayerMenu.ConditionOnDeath");
